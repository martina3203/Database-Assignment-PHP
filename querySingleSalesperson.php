...
<html><head><title>Query for Single Salesperson</title></head><body>
...
if(!empty($name)) {
  ...
  print "<tr> <td> <b> ID </b> </td> <td> <b> Saleperson Name </b> </td> <td> <b> Commission Rate (as a %) </b> </td> </tr> ";
...
<form name="query" method="post" action="querySingleSalesperson.php" enctype="multipart/form-data">
